...
The other broadly used characteristic is the \textit{use of memory}. From this perspective we distinguish Hyper-Heuristics with \textbf{on-line}, \textit{off-line} and \textbf{no} learning mechanisms. 
